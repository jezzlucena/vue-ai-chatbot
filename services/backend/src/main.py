from .constants import EOS_TOKEN, PARAGRAPH_TOKEN, INITIAL_COLOR, MODEL_NAME, DEVICE
from .models import ChatMessage, ChatbotState
...
"""Instance of the AutoModel populated with Qwen 2.5"""

tokenizer = AutoTokenizer.from_pretrained(MODEL_NAME)
"""Tokenizer used during the compute"""
